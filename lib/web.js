...
module.exports = (function () {
    ...
    function WEB() {
        var mime, connections = [], docroot, modules = {};
            ...
            new WebSocketServer({
                ...
                ws.on('message', function (message) {
                    try {
                        ...
                        modules[data.module][data.method].call(null, params, callback, clientID);
        ...
        this.html = function (params, cb, clientID) {
            fs.readFile(docroot + '/' + params.page, function (err, data) {
                if (err) {
                    console.error(err);
